...
输出：
  - gopro_calib.npz  ← 精确相机内参，供 aruco_detect.py 使用
  - 每张图的角点检测结果（目视确认）
"""
...
def generate_checkerboard():
    ...
    fname = "calibration_checkerboard.png"
...
def main():
    # 先生成棋盘格图片
    if not os.path.exists("calibration_checkerboard.png"):
        generate_checkerboard()
    else:
        print("棋盘格图片已存在: calibration_checkerboard.png")
