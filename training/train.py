...
MODELS = {
    "yolov5nu":  str(ROOT / "weights/yolov5nu.pt"),
    "yolov8n":   str(ROOT / "weights/yolov8n.pt"),
    "yolov9t":   str(ROOT / "weights/yolov9t.pt"),
    "yolov10n":  str(ROOT / "weights/yolov10n.pt"),
    "yolov11n":  str(ROOT / "weights/yolo11n.pt"),   # ultralytics drops the 'v': yolo11n, not yolov11n
}
...
def train_model(name: str, weights: str, args: dict) -> dict:
    ...
    return {
        ...
        "weights":   str(ROOT / "runs/train" / name / "weights" / "best.pt"),
    }
...
def main():
    ...
    for model_name in opt.models:
        ...
        best_pt = ROOT / "runs/train" / model_name / "weights" / "best.pt"
    ...
    if all_results:
        ...
        out_csv = ROOT / "runs/comparison_results.csv"
