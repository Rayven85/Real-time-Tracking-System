...
MODELS = {
    "yolov5nu": "runs/detect/runs/train/yolov5nu/weights/best.pt",
    "yolov8n":  "runs/detect/runs/train/yolov8n/weights/best.pt",
    "yolov9t":  "runs/detect/runs/train/yolov9t/weights/best.pt",
    "yolov10n": "runs/detect/runs/train/yolov10n/weights/best.pt",
    "yolov11n": "runs/detect/runs/train/yolov11n/weights/best.pt",
}
...
OUT_DIR   = Path("runs/visualization")
